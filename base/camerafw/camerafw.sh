...
if (echo "$prod_dev" | grep -qi "shamu"); then
  cp -rf $tmp_path/camerafw/experimental2016/* /system
elif (echo "$prod_dev" | grep -qi "Pixel"); then
  cp -rf $tmp_path/camerafw/experimental2016/* /system
elif (echo "$prod_dev" | grep -qi "Pixel XL"); then
  cp -rf $tmp_path/camerafw/experimental2016/* /system
else
  cp -rf $tmp_path/camerafw/experimental/* /system
fi
